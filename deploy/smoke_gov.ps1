...
.DESCRIPTION
    ...
    Probes mirror smoke_portal.ps1 exactly — both SPAs use the same Vite
    pattern, so the same three-probe shape catches the same failure modes
    (DNS broken, build artefacts missing, asset paths wrong).
