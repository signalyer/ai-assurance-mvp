...
## Files — Planned
### Sessions 08+ — Right-to-Forget, SDK/CLI, Hardening, Demo
- See docs/plans/12-DAY-PRODUCTION-SPRINT.md
- Session 08: Right-to-Forget + Tamper-Evident Audit (Day 8)
...
python -m pytest tests/ -v                                                     # after Session 07 — expect 82 passed
